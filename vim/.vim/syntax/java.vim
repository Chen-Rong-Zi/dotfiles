...
syn keyword javaRepeat		while for do switch
...
syn keyword Label	public protected private abstract
...
syntax match Type          /\v<\u\w{-}>/                        display
...
" syntax cluster hidden contains=Type,Function,Identifier,inBracket1,keyword,Keyword,Nontext,Nothing,Preproc
...
syntax keyword Keyword boolean  conceal cchar=𝔹

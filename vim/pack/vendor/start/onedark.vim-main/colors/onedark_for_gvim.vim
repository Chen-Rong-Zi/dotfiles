...
function! onedark_for_gvim#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! onedark_for_gvim#extend_highlight(group, style)
...
" call s:h("Normal", { "fg": s:foreground }) " have changed by rongzi ,the last line is the previous version

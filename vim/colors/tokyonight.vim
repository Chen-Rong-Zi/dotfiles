...
call s:HL('Conceal', s:palette.red, s:palette.none)
...
call s:HL('MatchParen', s:palette.blue, s:palette.bg1, 'bold,underline,undercurl,italic')
...
call s:HL('PreProc', s:palette.blue, s:palette.none)

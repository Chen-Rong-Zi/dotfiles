...
static const char *altbarcmd        = "~/.config/polybar/pwidgets/launch"; /* Alternate bar launch command */
...
// static const char *dmenucmd[] = { "bash ~/.config/polybar/pwidgets/scripts/powermenu.sh", NULL };
